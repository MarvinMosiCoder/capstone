...
<section>
  <div class="panel panel-default">
    <div class="panel-heading"><h3>Add Records</h3></div>
  ...
  <div class="reg-form"> 
    ...
    <div class="col-md-12">
      ...
      <div class="col-lg-12">
        <input type="hidden" name="residence_id" id='selectuser_id' class="form-control"  placeholder="Enter Entry"/>
      </div>
      </div>
    <div class="form-group">     
      <div class="col-lg-12">
         <label for="FirstName" ">Name OF Suspect</label>
...
<hr>
        ...
        <div class="form-group">
          <div class="container">
           ...
           <a type="submit" href="blotter_records.php" class="btn btn-primary" value="Save"> <i class="fa fa-back"></i> Back to Page</a>
          </div>
        </div>
